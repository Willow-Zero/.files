...
-- beautiful.init(gears.filesystem.get_configuration_dir() .. "/themes/default/theme.lua")
 local theme_path = string.format("/home/zero/.config/awesome/themes/default/theme.lua", os.getenv("HOME"), "default")
...
beautiful.wallpaper = "/home/zero/.config/awesome/themes/default/background.png"
...
{ rule = {name = "Mixer (Playback Devices) — KMix"},
...
--	tag		= "www"	})
--awful.spawn("kitty discordo", {
--	tag 	= "msg"})
--awful.spawn("kitty", {
--	tag	= "1"})
awful.spawn.once("kitty cmus", {
	tag	="2"})
awful.spawn("kitty nohup glava &", {
    tag	="2",
	request_no_titlebar	="true",	
	})
awful.spawn("kitty irssi", {
	tag	="msg"})
